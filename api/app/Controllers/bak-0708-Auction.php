        ...
        foreach ($grouped_auction_items as $buyer_id => $buyer_array) {
            ...
            foreach ($buyer_array as $seller_id => $seller_array) {
                ...
                $invoice_data = [
                    ...
                    'b_state' => @$sellerData['state_name'],
                    'b_state_id' => @$buyerData['state_id'],
                    'b_city_id' => @$buyerData['city_id'],
                    's_state' => @$buyerData['state_name'],
                    's_state_id' => @$sellerData['state_id'],
                    's_city_id' => @$sellerData['city_id'],
                    'b_city' => @$sellerData['city_name'],
                    's_city' => @$buyerData['city_name'],
                    'b_area' => @$sellerData['area_name'],
                    's_area' => @$buyerData['area_name'],
                    'b_gst' => @$sellerData['gst_no'],
                    's_gst' => @$buyerData['gst_no'],
                    'b_fssai' => @$sellerData['fssai_no'],
                    's_fssai' => @$buyerData['fssai_no'],
                    'b_tea' => @$sellerData['tea_board_no'],
                    's_tea' => @$buyerData['tea_board_no'],
                    'b_address' => @$sellerData['address'],
                    's_address' => @$buyerData['address'],
                ];
