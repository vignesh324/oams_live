...
class Settings extends ResourceController
{
    ...
    public function create()
    {
        ...
        $rules = [
            ...
            'ab_prefix' => 'required|regex_match[/^[a-zA-Z0-9][a-zA-Z0-9\-]*$/]',
            'as_prefix' => 'required|regex_match[/^[a-zA-Z0-9][a-zA-Z0-9\-]*$/]',
        ];
        ...
        $messages = [
            ...
            'as_prefix' => [
                'required' => 'The Auctioneer Seller Prefix field is required.',
            ],
            'ab_prefix' => [
                'required' => 'The Auctioneer Buyer Prefix field is required.',
            ],
        ];
        ...
        if (!$this->validate($rules, $messages)) {
            ...
            $data = [
                ...
                'ab_prefix' => $this->request->getVar('ab_prefix'),
                'as_prefix' => $this->request->getVar('as_prefix'),
            ];
            // print_r($data);exit;
