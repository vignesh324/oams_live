...
class Hsn extends Controller
{
	...
	public function index()
	{
		...
		return view('Applications\USER\Views\Hsn\index', [
			'data' => $data,
	...
	public function create()
	{
		...
		$data = new Hsn;
		$method = 'POST';
		return view('Applications\USER\Views\Hsn\create');
	}
	public function show()
	{
		...
		return view('Applications\USER\Views\Hsn\edit', ['response_data' => $response_data]);
	}
