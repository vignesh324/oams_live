...
class Invoice extends Controller
{
    ...
    public function index()
	{
		...
		return view('Applications\USER\Views\Invoice\index', [
			'data' => $data,
    ...
    public function view($id)
	{
		...
		$statecityarea_url = @apiURL . "user/stateCityArea";

		$_response = make_curl_request($statecityarea_url, $headers, 'GET');
		if (isset($response['error'])) {
		...
		return view('Applications\USER\Views\Invoice\view', [
			'data' => $data,
			'response_data' => $response_data['invoices'],
			'stateCityArea' => $stateCityArea,
		]);
	}
	...
	public function view2()
	{
		...
		return view('Applications\USER\Views\Invoice\view2',$data);
	}
}