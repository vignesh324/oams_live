...
class WarehouseStock extends Controller
{
    ...
    public function index()
	{
		...
		$url = @apiURL . "user/warehousestock";
		$token = session()->get('access_token');
		$headers = [
		...
		//echo '<pre>';print_r($response_data['inwarditems']);exit;
		//Index
		//Get Active Menu
		...
		return view('Applications\USER\Views\WarehouseStock\index',
		[
			'data' => $data,
			'response_data' => $response_data['inwarditems'],
		]);
	}
}