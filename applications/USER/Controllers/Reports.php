...
class Reports extends Controller
{
	...
	public function gardenCompareReport()
	{
		$token = session()->get('access_token');
		...
		$data_sidebar['activemenu'] = "GardenCompareSoldStockReport";

		$data['header'] = view('Applications\USER\Views\header', $data_sidebar);
		$data['sidebar'] = view('Applications\USER\Views\sidebar', $data_sidebar);
		$data['footer'] = view('Applications\USER\Views\footer', $data);

		return view('Applications\USER\Views\Reports\gardencompare_reports', [
			'data' => $data
		]);
	}
	...
	public function gardenCompareReportSubmit()
	{
		...
		$url = @apiURL . "user/gardenCompareReportSubmit";
		$token = session()->get('access_token');
		// Include the token in the headers
		$headers = [
			'Content-Type: application/json',
		...
		return view('Applications\USER\Views\Reports\views\buyergardenview2', ['response_data' => $response_data]);
	}
