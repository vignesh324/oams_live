...
class Package extends Controller
{
	...
	public function index()
	{
		...
		return view('Applications\USER\Views\Package\index', [
			'data' => $data,
	...
	public function create()
	{
		...
		$data = new Package;
		$method = 'POST';
		return view('Applications\USER\Views\Package\create');
	}
	public function show()
	{
		...
		$url = @apiURL . "user/package/" . $data['id'];
		$token = session()->get('access_token');
		...
		return view('Applications\USER\Views\Package\edit', ['response_data' => $response_data]);
	}
