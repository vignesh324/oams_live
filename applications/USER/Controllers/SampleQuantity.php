...
class SampleQuantity extends Controller
{
	...
	public function index()
	{
		...
		$url = @apiURL ."user/samplequantity";
		$token = session()->get('access_token');
		...
		// print_r($response_data['samplequantity']);exit;
		...
		return view('Applications\USER\Views\SampleQuantity\index', [
			'data' => $data,
	...
	{
		// print_r('hiii');
		$data = new SampleQuantity;
		$method = 'POST';
		return view('Applications\USER\Views\SampleQuantity\create');
	}
	public function show()
	{
		...
		$url = @apiURL ."user/samplequantity/" . $data['id'];
		$token = session()->get('access_token');
		...
		return view('Applications\USER\Views\SampleQuantity\edit', ['response_data' => $response_data]);
	}
	...
	public function update()
	{
		$session_user_id = session()->get('session_user_id');
		$id = $this->request->getpost('id');
		$url = @apiURL ."user/samplequantity/" . $id;
		$token = session()->get('access_token');
