                      ...
                      <div class="col-12 table-responsive">
                        <table class="table table-bordered table-striped">
                          ...
                          <tbody>
                            <?php
                            $key = 0; 
                            foreach ($auction_data['auctionItems'] as $auction_item) { ?>
                              <tr>
                                <td><?php echo ++$key; ?></td>
                                ...
                                <td><?php echo number_format($auction_item['weight_net']*$auction_item['auction_quantity'],3); ?></td>
                                <td><?php echo $auction_item['base_price']; ?></td>
                                <td><?php echo $auction_item['reverse_price']; ?></td>
                                <td><?php echo $auction_item['high_price']; ?></td>
                              </tr>
                            <?php
                            } ?>
                          </tbody>
