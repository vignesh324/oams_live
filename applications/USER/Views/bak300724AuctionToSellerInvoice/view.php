                    ...
                    <div class="card">
                        ...
                        <div class="card-body" id="printableArea">
                            ...
                            <div class="row mt-3">
                                <div class="col-6">
                                    <address>
                                        <strong>Regal Commodities</strong><br>
                                ...
                                <div class="col-6 text-right">
                                    <address>
                                        <strong>To,</strong><br>
                                        <?php echo $response_data['seller_name']; ?><br>
                                        <?php echo $response_data['s_address']; ?><br>
                                        <?php echo $response_data['s_area_name'] . ',' . $response_data['s_city_name'] . ',' . $response_data['s_state_name']; ?><br>
                                        <strong>FSSAI No:</strong> <?php echo $response_data['s_fssai']; ?><br>
                                        <strong>TeaBoard Reg No:</strong> <?php echo $response_data['s_tea']; ?><br>
                                        <strong>GSTIN:</strong> <?php echo $response_data['s_gst']; ?><br>
                                    </address>
                                </div>
                            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    if ($response_data['s_state_name'] == 'Tamil Nadu' || $response_data['s_state_id'] == 31) {
                                        $sgst = 9; // percentage
                                        $cgst = 9; // percentage
                                        $igst = 0.0; // percentage
                                    } else {
                                    ...
                                    foreach ($response_data['invoiceItems'] as $key => $value) {
                                        ...
                                        $qty = ($value['weight_net'] * $value['pkgs']) - $sq;
                                        $total_kgs += $qty;
                                        $value_price = $value['bid_price'] * $qty;
                                        $seller_charges = cal_percentage($response_data['settings_seller_charges'], $value_price);
                                        $sgst_amount = cal_percentage($sgst, $seller_charges);
                                        $cgst_amount = cal_percentage($cgst, $seller_charges);
                                        $igst_amount = cal_percentage($igst, $seller_charges);
                                        $net_amount = $seller_charges + $sgst_amount + $cgst_amount + $igst_amount;
                                        $total_net_amount += $net_amount;
                                        $total_sgst += $sgst_amount;
                                        $total_cgst += $cgst_amount;
                                        $total_igst += $igst_amount;
                                        $total_seller_charges += $seller_charges;
                                    ?>
                                        <tr>
                            ...
                            <div class="m-2">
                                <div class="row">
                                    <div class="col">
                                        <b>Service Charge:</b><br> <?php echo $total_seller_charges; ?>
                                    </div>
                                    <div class="col">
