                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="#" class="btn btn-dark-cyne edit_button" onclick="showAuctionBiddings(<?php echo @$value['auction_item_id']; ?>)" title="View Bid(s)" id="ids" data-toggle="modal" data-target="#modal-sm"><span><i class="fa fa-eye" title="View"></i></span></a>
                          </td>
                        </tr>
                      <?php 
                          }
