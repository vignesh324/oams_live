  ...
  <div class="wrapper">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php foreach ($response_data['area'] as $key => $value) : ?>
                        <tr>
                          <td><?php echo $key + 1; ?></td>
                          <td><?php echo $value['name']; ?></td>
                          <td><?php echo AREA . $value['id']; ?></td>
    ...
    <script>
      ...
      $(document).on("click", "#add-area", function(event) {
        ...
        var url = '<?= @basePath ?>USER/Area/Create';
        var formmethod = 'post';
        var formdata = $('form#area-form').serialize();
      ...
      $(document).on("click", "#edit-area", function(event) {
        ...
        var url = '<?= @basePath ?>USER/Area/Update';
        var formmethod = 'post';
        var formdata = $('form#area-form-edit').serialize();
        console.log(formdata);
        $.ajax({
          url: url,
          type: formmethod,
