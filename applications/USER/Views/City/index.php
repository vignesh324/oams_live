...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    $filtered_permissions = array_filter($permissions, function ($value, $key) {
      return $value['module_id'] == 2;
    }, ARRAY_FILTER_USE_BOTH);

    $city_permission = array_values($filtered_permissions);
    // print_r($city_permission);exit;
    ?>
    <!-- Navbar -->
    <?= @$header ?>
    <!-- /.navbar -->
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php foreach ($response_data['city'] as $key => $value) : ?>
                        <tr>
                          <td><?php echo $key + 1; ?></td>
                          <td><?php echo $value['name']; ?></td>
                          <td><?php echo CITY . $value['id']; ?></td>
    ...
    <script>
      ...
      $(document).on("click", "#add-city", function(event) {
        ...
        var url = '<?= @basePath ?>USER/City/Create';
        var formmethod = 'post';
        var formdata = $('form#city-form').serialize();
      ...
      $(document).on("click", "#edit-city", function(event) {
        ...
        var url = '<?= @basePath ?>USER/City/Update';
        var formmethod = 'post';
        var formdata = $('form#city-form-edit').serialize();
        console.log(formdata);
        $.ajax({
          url: url,
          type: formmethod,
