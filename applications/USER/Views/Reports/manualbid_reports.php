          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Manual Bid Reports</li>
              </ol>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header d-flex justify-content-between ">
                  <h3 class="card-title">Manual Bid Reports</h3>
                  <button type="button" id="export" class="btn btn-primary ms-auto  text-end">Export</button>
                  <input type="hidden" value="manualbid_report" class="excel-file-name">
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col col-2">
                      <div class="form-group">
                        ...
                        <span class="error" id="lot_no" style="display: none;">Please Select Lot No</span>
                      </div>
                    </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        function handleSearchFilterClick(event) {
          ...
          $.ajax({
            url: '<?= @basePath ?>USER/ManualBidReportSubmit',
            type: 'post',
            dataType: 'JSON',
            data: {
              from_date: from_date,
            ...
            success: function(response) {
              ...
              if (response && response.auctionBiddings.length > 0) {
                var tableBody = '';
                var groupedBiddings = {};

                // Group biddings by lot_no
                response.auctionBiddings.forEach(function(item) {
