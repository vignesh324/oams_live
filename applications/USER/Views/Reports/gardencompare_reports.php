            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                  <h3 class="card-title">Garden wise comparitive sold qty</h3>
                  <input type="hidden" value="garden-compare-report" class="excel-file-name">
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col col-2">
                      <div class="form-group">
                        ...
                        <select class="select2" name="garden_id[]" id="garden_id" multiple="multiple" data-placeholder="Select Garden" data-dropdown-css-class="select2-purple" style="width: 100%;">
    ...
    <script>
      $(document).ready(function() {
        ...
        function handleSearchFilterClick(event) {
          ...
          if (garden_id.length <= 0) {
            displayError('garden_id', 'Please select Garden');
            hasError = true;
          }
          if (garden_id.length > 4) {
            displayError('garden_id', 'Please select only 4 gardens');
            hasError = true;
          }
          // if (!buyer_id) {
          ...
          $.ajax({
            url: '<?= @basePath ?>USER/GardenCompareReportSubmit',
            type: 'post',
            dataType: 'html',
            data: {
              from_date: from_date,
