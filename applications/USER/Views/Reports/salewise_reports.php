            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                  <h3 class="card-title">Buyerwise Purchase Qty Reports</h3>
                  <input type="hidden" value="buyerwise_report" class="excel-file-name">
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <div class="row">
    ...
    <script>
      $(document).ready(function() {
        ...
        function handleSearchFilterClick(event) {
          ...
          $.ajax({
            url: '<?= @basePath ?>USER/SaleWiseReportSubmit',
            type: 'post',
            dataType: 'html',
            data: {
              from_date: from_date,
