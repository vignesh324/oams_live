            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Buyer wise / Seller wise / Garden wise sold qty Reports</h3>
                  <input type="hidden" value="buyer_seller_garden_sold_qty_report" class="excel-file-name">
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <div class="row">
      ...
      $(document).ready(function() {
        ...
        function handleSaleNoChange() {
          ...
          $.ajax({
            ...
            error: function() {
              handleError('#seller_id', 'No data found');
            }
          });
        }
        ...
        function handleSellerChange() {
          ...
          $.ajax({
            url: "<?= @basePath ?>USER/SellerWiseBuyer",
            type: "POST",
            data: {
              seller_id: seller_id
            },
        ...
        function populateSellers(response) {
          ...
          if (response.seller && response.seller.length > 0) {
