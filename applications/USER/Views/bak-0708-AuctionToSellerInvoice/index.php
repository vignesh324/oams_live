                    ...
                    <tbody>
                      ...
                      foreach ($response_data as $key => $val) : ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?= @basePath ?>USER/AuctionToSellerInvoice/View/<?php echo base64_encode($val['id']); ?>" class="btn btn-dark-cyne edit_button" id="#" style="margin-right: 5px;"><i class="fa fa-eye" title="View"></i> </a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
