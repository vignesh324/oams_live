<form id="package-form-edit">
    ...
    <div class="modal-body">
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="name" placeholder="Enter Package Name" value="<?php echo $response_data['name'] ?>">
            </div>
            <div class="form-group">
    ...
    <div class="modal-footer justify-content-between">
        ...
        <button type="button" id="edit-package" class="btn btn-primary">Save changes</button>
    </div>
</form>