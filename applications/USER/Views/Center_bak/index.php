                    ...
                    <?php foreach($response_data as $key => $value) : ?>
                      <tr>
                        ...
                        <a href="#" onclick="editCenter(<?php echo $value['id']; ?>)" class="btn btn-dark-cyne edit_button" id="editButton" style="margin-right: 5px;" data-toggle="modal" data-target="#modal-sm">
                            ...
                            <a href="#" onclick="assignGrade(<?php echo $value['id'];?>)" data-toggle="modal" data-target="#modal-assign" class="btn btn-dark-cyne edit_button" id="#" style="margin-right: 5px;"><i class="fa fa-arrow-right" title="Assign"></i> </a> 
                        </td>
                      </tr>
                      <?php endforeach;?>
...
$('.select2bs4').select2({
  theme: 'bootstrap4'
    ...
    function assignGrade(id) {
      ...
      $.ajax({
        type: "post",
        url: "<?= @basePath ?>USER/Center/AssignGrade",
        data: {
          id: id
        },
        dataType: 'html',
