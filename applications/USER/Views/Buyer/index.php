      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <?php if ($buyer_permission[0]['create_permission'] == 1) { ?>
                <button class="btn btn-app float-sm-right" onclick="addBuyer()" data-toggle="modal" data-target="#modal-sm">
                    ...
                    <tbody>
                      <?php foreach ($response_data as $key => $value) : ?>
                        <tr>
                          ...
                          <td>
                            <?php if ($buyer_permission[0]['update_permission'] == 1) { ?>
                              <a href="#" onclick="editBuyer(<?php echo $value['id']; ?>)" class="btn btn-dark-cyne edit_button" id="editButton" style="margin-right: 5px;" data-toggle="modal" data-target="#modal-sm">
                                <i class="fa fa-edit" title="Edit"></i>
                              </a>
                            <?php } ?>

                            <?php if ($buyer_permission[0]['delete_permission'] == 1) { ?>
                              <a href="#" title="Delete" onclick="deleteBuyer(<?php echo $value['id']; ?>)" id="ids" class="btn btn-dark-cyne delete_button">
