...
<tbody>
    <?php foreach ($response_data['invoiceItems'] as $data) :
        ...
        <tr>
            ...
            <td class="text-center"><?php echo number_format((isset($leafQuantity) && $leafQuantity > 0) ? $leafBidPrice / $leafQuantity : 0, 2); ?></td>
            <td class="text-center"><?php echo number_format($dustQuantity, 2); ?></td>
            <td class="text-center"><?php echo number_format((isset($dustQuantity) && $dustQuantity > 0) ? $dustBidPrice / $dustQuantity : 0, 2); ?></td>
