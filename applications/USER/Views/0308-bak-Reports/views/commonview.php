...
<tbody>
    <?php foreach ($response_data['invoiceItems'] as $data) :
        ...
        $leafQuantity1 = $data['leaf_total_quantity1'];
        $dustQuantity1 = $data['dust_total_quantity1'];
        ...
        <tr>
            ...
            <td class="text-center"><?php echo number_format($leafBidPrice, 2); ?></td>
            <td class="text-center"><?php echo number_format($dustQuantity, 2); ?></td>
            <td class="text-center"><?php echo number_format($dustBidPrice, 2); ?></td>
