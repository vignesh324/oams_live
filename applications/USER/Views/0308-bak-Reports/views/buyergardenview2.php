...
<tbody>
    ...
    if (isset($response_data) && is_array($response_data) && count($response_data) > 0) {
        ...
        foreach ($response_data as $index => $value) {
            ...
            if ($currentGarden !== $value['garden_name']) {
                if ($currentGarden !== '') {
                    ...
                    $avgGardenTotalPrice = (isset($currentGardenQty) && $currentGardenQty > 0) ? $currentGardenPrice / $currentGardenQty : 0;
                    ?>
                    <tr>
            ...
            $percentage = (isset($currentGardenQty) && $currentGardenQty > 0) ? ($offeredQty / $currentGardenQty) * 100 : 0;
            ?>
            <tr>
        ...
        $avgGrandTotalPrice = (isset($grandTotalQty) && $grandTotalQty > 0) ? $grandTotalPrice / $grandTotalQty : 0;
        ?>
<tfoot>
    <tr>
