  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <span id="access_denied" class="invalid_error" style="display: none;">Access Denied</span>
        <form action="<?= @basePath ?>SA/Login" id="loginForm" method="post">
    ...
    $(document).on("click", "#login-submit", function(event) {
      ...
      $.ajax({
        ...
        success: function(_response) {
          ...
          window.location.href = '<?= @basePath ?>SA/DashboardSA';
