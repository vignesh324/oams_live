<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
  <a href="<?= @basePath ?>BUYER/Dashboard" class="brand-link">
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?= @basePath ?>BUYER/Dashboard" class="nav-link <?= @($activemenu == 'Dashboard') ? 'active' : '' ?>">
        ...
        <li class="nav-item">
          <a href="<?= @basePath ?>BUYER" class="nav-link <?= @($activemenu == 'Roll') ? 'active' : '' ?>">
            <i class="nav-icon fas fa-tachometer-alt"></i>
            <p>
              Logout
              <span class="right badge badge-danger"></span>
