...
<head>
  ...
  <!-- Google Font: Source SELLERns Pro -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+SELLERns+Pro:300,400,400i,700&display=fallback">
  <!-- Font Awesome Icons -->
        ...
        <div class="row">
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-striped table-valign-middle">
                  ...
                  <tr>
                    <td>
                      <img src="<?=@basePath?>admin_assets/dist/img/default-150x150.png" alt="Product 1" class="img-circle img-size-32 mr-2">
                      Some Product
                    </td>
                    <td>$13 USD</td>
                    <td>
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">SELLERles</h3>
                  <a href="javascript:void(0);">View Report</a>
                </div>
              </div>
              <div class="card-body">
                ...
                <div class="position-relative mb-4">
                  <canvas id="SELLERles-chart" height="200"></canvas>
                </div>
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center border-bottom mb-3">
                  ...
                  <p class="d-flex flex-column text-right">
                    ...
                    <span class="text-muted">SELLERLES RATE</span>
                  </p>
                </div>
                <!-- /.d-flex -->
